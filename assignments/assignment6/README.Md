...
5. **Extra Credit**:
- We implemented 1 Extra Credit Image Downscaling. Since this was a new image processing feature we added a new method in the Image model interface and implemented the same. 
