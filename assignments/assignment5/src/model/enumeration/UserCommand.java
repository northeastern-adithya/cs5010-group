...
public enum UserCommand {
  ...
  RED_COMPONENT("red-component", "red-component image-name dest-image-name: "
          + "Create an image with the red-component of the image with the given name, "
          + "and refer to it henceforth in the program by the given destination name."),
  GREEN_COMPONENT("green-component", "green-component image-name dest-image-name: "
          + "Create an image with the green-component of the image with the given name, "
          + "and refer to it henceforth in the program by the given destination name."),
  BLUE_COMPONENT("blue-component", "blue-component image-name dest-image-name: "
          + "Create an image with the blue-component of the image with the given name, "
          + "and refer to it henceforth in the program by the given destination name."),
  VALUE_COMPONENT("value-component", "value-component image-name dest-image-name: "
          + "Create an image with the value-component of the image with the given name, "
          + "and refer to it henceforth in the program by the given destination name."),
  LUMA_COMPONENT("luma-component", "luma-component image-name dest-image-name: "
          + "Create an image with the luma-component of the image with the given name, "
          + "and refer to it henceforth in the program by the given destination name."),
  INTENSITY_COMPONENT("intensity-component", "intensity-component image-name dest-image-name: "
          + "Create an image with the intensity-component of the image with the given name, "
          + "and refer to it henceforth in the program by the given destination name."),
  HORIZONTAL_FLIP("horizontal-flip", "horizontal-flip image-name dest-image-name: "
  ...
  RGB_SPLIT("rgb-split", "rgb-split image-name "
          ...
          + "These would be the same images that would be individually produced with "
          + "the red-component, green-component and blue-component commands."),
  RGB_COMBINE("rgb-combine", "rgb-combine image-name red-image green-image blue-image: "
          + "Combine the three images that are individually red, green and blue "
